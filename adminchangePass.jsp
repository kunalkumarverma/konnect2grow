...
<form action="admin?action=cpass" onSubmit='return checkValue(this)' method='post'>

<br><br>
<table background="images/tableb.png" border=0 align=center cellpadding=8 cellspacing=4 class='login' width=580 height=300>
<tr><th align=center class=bghead2>Admin Change Password</th>
</tr>
<tr>
<td style='color:red'>
${MSG}
