...
xmlhttp.onreadystatechange=function()
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
    ...
    document.getElementById('resetpwd').innerHTML=xmlhttp.responseText;
	  
    }
  }
try{
xmlhttp.open("GET","seeder?action=RESET&SEEDERID="+sid,true);
}
catch(e){
...
<table border=0 align=center cellpadding=4 cellspacing=4 class='login2' width=550 height=180>
<tr class=th1><th colspan=2 align=left>Share & Grow</th>
</tr>
<tr>
<td colspan=2 style="color:magenta;">My K2G Id : ${SEEDER.seederid}</td>
</tr>
...
<tr>
<td>Date of Join : ${SEEDER.doj}</td><td align=right><label id='resetpwd'>(PWD)</label></td>

</tr>
<tr>
<td>My Level : ${SEEDER.level}</td>
<td align=right><a href="javascript:resetPwd('${SEEDER.seederid}');">(Reset Password)</a></td>
</tr>
...
<tr class='thead1'><th align=center>&#128279; Seeder Profile &#128279;</th>
</tr>
<tr>
